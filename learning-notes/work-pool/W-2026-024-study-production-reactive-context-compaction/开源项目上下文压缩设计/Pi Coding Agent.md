...
用户指定必看；官方文档列出自动压缩、手动 compact 与消息历史实现入口。

## 项目与源码入口

- 官方仓库：[源代码与版本](https://github.com/ai-cre/pi-mono)
- 官方压缩文档/源码入口：[初步入口](https://github.com/ai-cre/pi-mono/blob/main/packages/coding-agent/docs/compaction.md)
- 第二观察入口：[源码/配置](https://github.com/ai-cre/pi-mono/blob/main/packages/coding-agent/src/core/compaction/compaction.ts)
- W-2026-032 对应 Prompt/缓存笔记：[关联笔记](../../W-2026-032-study-agent-context-organization-and-prompt-cache-Context缓存/开源项目缓存设计/Pi%20Coding%20Agent.md)
