...
官方文档明确覆盖手动/自动压缩、overflow recovery 与可插拔 Context Engine，最贴近本任务的应急恢复主题。

## 项目与源码入口

- 官方仓库：[源代码与版本](https://github.com/openclaw/openclaw)
- 官方压缩文档/源码入口：[初步入口](https://github.com/openclaw/openclaw/blob/main/docs/concepts/compaction.md)
- 第二观察入口：[源码/配置](https://github.com/openclaw/openclaw/blob/main/docs/concepts/context-engine.md)
- W-2026-032 对应 Prompt/缓存笔记：[关联笔记](../../W-2026-032-study-agent-context-organization-and-prompt-cache-Context缓存/开源项目缓存设计/OpenClaw.md)
