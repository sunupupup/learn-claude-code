...
提供 Condenser/View/Condensation 抽象，并有 context window exceeded 路径可追踪。

## 项目与源码入口

- 官方仓库：[源代码与版本](https://github.com/OpenHands/software-agent-sdk)
- 官方压缩文档/源码入口：[初步入口](https://github.com/OpenHands/software-agent-sdk/blob/main/openhands-sdk/openhands/sdk/context/condenser/base.py)
- 第二观察入口：[源码/配置](https://github.com/OpenHands/software-agent-sdk/blob/main/openhands-sdk/openhands/sdk/agent/agent.py)
- W-2026-032 对应 Prompt/缓存笔记：[关联笔记](../../W-2026-032-study-agent-context-organization-and-prompt-cache-Context缓存/开源项目缓存设计/OpenHands%20SDK.md)
