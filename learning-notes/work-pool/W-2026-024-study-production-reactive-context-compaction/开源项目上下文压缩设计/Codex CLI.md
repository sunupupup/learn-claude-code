...
有独立 compaction 模块，可追踪压缩历史构造、保留上下文与检查点语义。

## 项目与源码入口

- 官方仓库：[源代码与版本](https://github.com/openai/codex)
- 官方压缩文档/源码入口：[初步入口](https://github.com/openai/codex/blob/main/codex-rs/core/src/compact.rs)
- 第二观察入口：[源码/配置](https://github.com/openai/codex/blob/main/codex-rs/core/src/context_manager/history.rs)
- W-2026-032 对应 Prompt/缓存笔记：[关联笔记](../../W-2026-032-study-agent-context-organization-and-prompt-cache-Context缓存/开源项目缓存设计/Codex%20CLI.md)
