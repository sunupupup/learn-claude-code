...
有 micro-compaction 设计文档及压缩 Facade/状态处理代码，适合对照渐进压缩与会话持久化。

## 项目与源码入口

- 官方仓库：[源代码与版本](https://github.com/NousResearch/hermes-agent)
- 官方压缩文档/源码入口：[初步入口](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/developer-guide/micro-compaction.md)
- 第二观察入口：[源码/配置](https://github.com/NousResearch/hermes-agent/blob/main/agent/compression_facade.py)
- W-2026-032 对应 Prompt/缓存笔记：[关联笔记](../../W-2026-032-study-agent-context-organization-and-prompt-cache-Context缓存/开源项目缓存设计/Hermes%20Agent.md)
